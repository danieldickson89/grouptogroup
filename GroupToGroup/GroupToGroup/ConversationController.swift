...
class ConversationController {
    ...
    static func createConversation(name: String, groups: [Group], users: [User], completion: (conversation: Conversation?) -> Void) {
        var conversation = Conversation(name: name, groups: groups, users: users)
        conversation.save()
